...
// Open brep geometry
Merge "Body_Geometry.brep";

// Characteristic Length

// min, max Characteristic Length
Mesh.CharacteristicLengthMax = 0.42;
...
// Boundaries
Physical Surface ("patch_1_0") = {2, 5, 8, 9, 10};
Physical Surface ("patch_2_0") = {3};
Physical Surface ("patch_3_0") = {7};
Physical Surface ("patch_4_0") = {1, 4, 6};
