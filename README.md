...
Docker containers offer a convenient way of providing pre-compiled containers for both windows and linux. macOS can also be supported but
...
2. If using podman, open a cmd window and issue the following command: `podman machine init`
